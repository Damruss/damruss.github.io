...
var homeName = home.map(home => home.homeName);
...
function SaveButton(options) {
  ...
  elem.onclick = function(event) {
    if (event.target.closest('.btn_save')) {
        ...
        if (document.getElementById("inp_ChangeName").value==false) {
            document.getElementById("inp_ChangeName").classList.remove("valid");
            document.getElementById("inp_ChangeName").classList.add('invalid');
            document.getElementById("btn_save_id").classList.remove("valid");
            document.getElementById("btn_save_id").classList.add('invalid');
        } else {
...
function ToValidate() {
    inp_ChangeName.classList.add("valid");
    inp_ChangeName.classList.remove("invalid");
    document.getElementById("btn_save_id").classList.remove("invalid");
    document.getElementById("btn_save_id").classList.add('valid');
};
